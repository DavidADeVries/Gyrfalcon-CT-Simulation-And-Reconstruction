 ...
 *
 * interpolateFrameForIndex_emxutil.c
 *
 * Code generation for function 'interpolateFrameForIndex_emxutil'
 *
 */
...
/* End of code generation (interpolateFrameForIndex_emxutil.c) */
