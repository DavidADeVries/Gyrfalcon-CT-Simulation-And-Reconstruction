function [xCoords, yCoords, zCoords] = getVoxelCentreAndEndEdgeCoordinates(locationInM, voxelDimsInM, dims)
% [xCoords, yCoords, zCoords] = getVoxelCentreAndEndEdgeCoordinates(locationInM, voxelDimsInM, dims)
...
% add on edges
endLocationInM = locationInM + [1 -1 -1] .* (dims+1) .* voxelDimsInM;

xCoords = [locationInM(1), xCoords, endLocationInM(1)];
yCoords = [locationInM(2), yCoords, endLocationInM(2)];
zCoords = [locationInM(3), zCoords, endLocationInM(3)];
