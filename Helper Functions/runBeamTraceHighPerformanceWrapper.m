function detectorData = runBeamTraceHighPerformanceWrapper(scan, source, detector, slicePosition, angle, zStep, xyStep, zDetector, xyDetector, phantomData, voxelDimsInM, phantomLocationInM, beamCharacterization, scatteringNoiseLevel, detectorNoiseLevel, partialPixel, partialPixelResolution)
