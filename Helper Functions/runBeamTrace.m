function [detectorData, attenuationCoords, attenuationDistances] = runBeamTrace(axesHandle, sourceStartBoxCoords, sourceEndBoxCoords, sourceDirectionUnitVector, detectorCornerCoords, phantomData, phantomDims, voxelDimsInM,  phantomLocationInM,  beamCharacterization, scatteringNoiseLevel, detectorNoiseLevel, partialPixel, partialPixelModelingResolution, displayDetectorRayTrace)
