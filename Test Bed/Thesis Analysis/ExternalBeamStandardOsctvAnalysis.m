...
sheetName = 'Stand. OSC-TV All Trials';
...
osctvBase.numIterationsValues = {'25'};
osctvBase.numSubsetsValues = {'[205 41]'};

osctvBaseNoFF = osctvBase;
osctvBaseNoFF.usedFloodFields = false;
osctvBaseNoFF.cValues = {'0.01'};
...
% ** Gel 2-1/2-2 (500MU) **
controlPath = 'F:\Thesis Recon Data\Gel 2-1\Gel 2-1_HR.vff';
catheterCoordsFile = 'F:\Thesis Recon Data\Gel 2-2\Catheter Coords.mat';
gelName = 'Gel 2-2';

gel2_2Control = fdkBase;
gel2_2Control.gelName = 'Gel 2-1';
gel2_2Control.readPath = 'F:\Thesis Recon Data\Gel 2-1\Gel 2-1_HR.vff';
gel2_2Control.controlPath = controlPath;
gel2_2Control.catheterCoordsFile = catheterCoordsFile;

gel2_2Fdk = fdkBase;
gel2_2Fdk.gelName = gelName;
gel2_2Fdk.readPath = 'F:\Thesis Recon Data\Gel 2-2\Gel 2-2_HR.vff';
gel2_2Fdk.controlPath = controlPath;
gel2_2Fdk.catheterCoordsFile = catheterCoordsFile;

gel2_2OsctvNoFF = osctvBaseNoFF;
gel2_2OsctvNoFF.gelName = gelName;
gel2_2OsctvNoFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 2-2)\';
gel2_2OsctvNoFF.controlPath = controlPath;
gel2_2OsctvNoFF.catheterCoordsFile = catheterCoordsFile;
gel2_2OsctvNoFF.reconNumberStart = 1;

gel2_2OsctvFF = osctvBaseFF;
gel2_2OsctvFF.gelName = gelName;
gel2_2OsctvFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 2-2 FF-R)\';
gel2_2OsctvFF.controlPath = controlPath;
gel2_2OsctvFF.catheterCoordsFile = catheterCoordsFile;
gel2_2OsctvFF.reconNumberStart = 1;


% ** Gel 2-3/2-4 (1500MU) **
controlPath = 'F:\Thesis Recon Data\Gel 2-3\Gel 2-3_HR.vff';
catheterCoordsFile = 'F:\Thesis Recon Data\Gel 2-4\Catheter Coords.mat';
gelName = 'Gel 2-4';

gel2_4Control = fdkBase;
gel2_4Control.gelName = 'Gel 2-3';
gel2_4Control.readPath = 'F:\Thesis Recon Data\Gel 2-3\Gel 2-3_HR.vff';
gel2_4Control.controlPath = controlPath;
gel2_4Control.catheterCoordsFile = catheterCoordsFile;

gel2_4Fdk = fdkBase;
gel2_4Fdk.gelName = gelName;
gel2_4Fdk.readPath = 'F:\Thesis Recon Data\Gel 2-4\Gel 2-4_HR.vff';
gel2_4Fdk.controlPath = controlPath;
gel2_4Fdk.catheterCoordsFile = catheterCoordsFile;

gel2_4OsctvNoFF = osctvBaseNoFF;
gel2_4OsctvNoFF.gelName = gelName;
gel2_4OsctvNoFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 2-4)\';
...
gel2_4OsctvFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 2-4 FF-R)\';
...
% ** Gel 4-1/4-2 (2000MU) **
controlPath = 'F:\Thesis Recon Data\Gel 4-1\Gel 4-1_HR.vff';
catheterCoordsFile = 'F:\Thesis Recon Data\Gel 4-2\Catheter Coords.mat';
gelName = 'Gel 4-2';

gel4_2Control = fdkBase;
gel4_2Control.gelName = 'Gel 4-1';
gel4_2Control.readPath = 'F:\Thesis Recon Data\Gel 4-1\Gel 4-1_HR.vff';
gel4_2Control.controlPath = controlPath;
gel4_2Control.catheterCoordsFile = catheterCoordsFile;

gel4_2Fdk = fdkBase;
gel4_2Fdk.gelName = gelName;
gel4_2Fdk.readPath = 'F:\Thesis Recon Data\Gel 4-2\Gel 4-2_HR.vff';
gel4_2Fdk.controlPath = controlPath;
gel4_2Fdk.catheterCoordsFile = catheterCoordsFile;

gel4_2OsctvNoFF = osctvBaseNoFF;
gel4_2OsctvNoFF.gelName = gelName;
gel4_2OsctvNoFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 4-2)\';
gel4_2OsctvNoFF.controlPath = controlPath;
gel4_2OsctvNoFF.catheterCoordsFile = catheterCoordsFile;
gel4_2OsctvNoFF.reconNumberStart = 54;

gel4_2OsctvFF = osctvBaseFF;
gel4_2OsctvFF.gelName = gelName;
gel4_2OsctvFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 4-2 FF-R)\';
gel4_2OsctvFF.controlPath = controlPath;
gel4_2OsctvFF.catheterCoordsFile = catheterCoordsFile;
gel4_2OsctvFF.reconNumberStart = 54;


% ** Gel 4-3/4-4 (2500MU) **
controlPath = 'F:\Thesis Recon Data\Gel 4-3\Gel 4-3_HR.vff';
catheterCoordsFile = 'F:\Thesis Recon Data\Gel 4-4\Catheter Coords.mat';
gelName = 'Gel 4-4';

gel4_4Control = fdkBase;
gel4_4Control.gelName = 'Gel 4-3';
gel4_4Control.readPath = 'F:\Thesis Recon Data\Gel 4-3\Gel 4-3_HR.vff';
gel4_4Control.controlPath = controlPath;
gel4_4Control.catheterCoordsFile = catheterCoordsFile;

gel4_4Fdk = fdkBase;
gel4_4Fdk.gelName = gelName;
gel4_4Fdk.readPath = 'F:\Thesis Recon Data\Gel 4-4\Gel 4-4_HR.vff';
gel4_4Fdk.controlPath = controlPath;
gel4_4Fdk.catheterCoordsFile = catheterCoordsFile;

gel4_4OsctvNoFF = osctvBaseNoFF;
gel4_4OsctvNoFF.gelName = gelName;
gel4_4OsctvNoFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 4-4)\';
...
gel4_4OsctvFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 4-4 FF-R)\';
...
controlPath = 'F:\Thesis Recon Data\Gel 5-1\Gel 5-1_HR.vff';
catheterCoordsFile = 'F:\Thesis Recon Data\Gel 5-2\Catheter Coords.mat';
gelName = 'Gel 5-2';

gel5_2Control = fdkBase;
gel5_2Control.gelName = 'Gel 5-1';
gel5_2Control.readPath = 'F:\Thesis Recon Data\Gel 5-1\Gel 5-1_HR.vff';
gel5_2Control.controlPath = controlPath;
gel5_2Control.catheterCoordsFile = catheterCoordsFile;

gel5_2Fdk = fdkBase;
gel5_2Fdk.gelName = gelName;
gel5_2Fdk.readPath = 'F:\Thesis Recon Data\Gel 5-2\Gel 5-2_HR.vff';
gel5_2Fdk.controlPath = controlPath;
gel5_2Fdk.catheterCoordsFile = catheterCoordsFile;

gel5_2OsctvNoFF = osctvBaseNoFF;
gel5_2OsctvNoFF.gelName = gelName;
gel5_2OsctvNoFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 5-2)\';
...
gel5_2OsctvFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 5-2 FF-R)\';
...
controlPath = 'F:\Thesis Recon Data\Gel 5-1\Gel 5-1_HR.vff';
catheterCoordsFile = 'F:\Thesis Recon Data\Gel 5-3\Catheter Coords.mat';
gelName = 'Gel 5-3';

gel5_3Control = fdkBase;
gel5_3Control.gelName = 'Gel 5-1';
gel5_3Control.readPath = 'F:\Thesis Recon Data\Gel 5-1\Gel 5-1_HR.vff';
gel5_3Control.controlPath = controlPath;
gel5_3Control.catheterCoordsFile = catheterCoordsFile;

gel5_3Fdk = fdkBase;
gel5_3Fdk.gelName = gelName;
gel5_3Fdk.readPath = 'F:\Thesis Recon Data\Gel 5-3\Gel 5-3_HR.vff';
gel5_3Fdk.controlPath = controlPath;
gel5_3Fdk.catheterCoordsFile = catheterCoordsFile;

gel5_3OsctvNoFF = osctvBaseNoFF;
gel5_3OsctvNoFF.gelName = gelName;
gel5_3OsctvNoFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 5-3)\';
...
gel5_3OsctvFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 5-3 FF-R)\';
...
controlPath = 'F:\Thesis Recon Data\Gel 5-1\Gel 5-1_HR.vff';
catheterCoordsFile = 'F:\Thesis Recon Data\Gel 5-4\Catheter Coords.mat';
gelName = 'Gel 5-4';

gel5_4Control = fdkBase;
gel5_4Control.gelName = 'Gel 5-1';
gel5_4Control.readPath = 'F:\Thesis Recon Data\Gel 5-1\Gel 5-1_HR.vff';
gel5_4Control.controlPath = controlPath;
gel5_4Control.catheterCoordsFile = catheterCoordsFile;

gel5_4Fdk = fdkBase;
gel5_4Fdk.gelName = gelName;
gel5_4Fdk.readPath = 'F:\Thesis Recon Data\Gel 5-4\Gel 5-4_HR.vff';
gel5_4Fdk.controlPath = controlPath;
gel5_4Fdk.catheterCoordsFile = catheterCoordsFile;

gel5_4OsctvNoFF = osctvBaseNoFF;
gel5_4OsctvNoFF.gelName = gelName;
gel5_4OsctvNoFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 5-4)\';
...
gel5_4OsctvFF.readPath = 'E:\Data Files\Git Repos\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 5-4 FF-R)\';
...
crunchParameterOptimizationMetrics(...
    {...
    gel2_2Control, gel2_2Fdk, gel2_2OsctvNoFF, gel2_2OsctvFF,...
