function [] = writeDoseSlices_Gel6_3b()
%UNTITLED3 Summary of this function goes here
%   Detailed explanation goes here

readPath = 'E:\Local Gyrfalcon Data\HDR Irradiations\Gel 6-3b\Slicer Exports\';
...
root = 'E:\Thesis Figures\Results\HDR\ProGuide (2 Cath, 5 Dwell)\Slices\';
...
%rotate the volumes so we can get a good transverse slice through both
%catheters

tps = imrotate3(tps, -28, [0 0 1], 'linear', 'crop');
fdk = imrotate3(fdk, -28, [0 0 1], 'linear', 'crop');
osctv = imrotate3(osctv, -28, [0 0 1], 'linear', 'crop');
osctv_RR = imrotate3(osctv_RR, -28, [0 0 1], 'linear', 'crop');
