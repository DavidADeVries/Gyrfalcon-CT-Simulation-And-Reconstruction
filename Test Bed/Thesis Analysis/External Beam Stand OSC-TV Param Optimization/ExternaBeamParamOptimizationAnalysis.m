% output params
writePath = 'E:\Thesis Results\External Beam Trials (Recheck).xls';
...
osctvBase.numIterationsValues = {'t'};%{'10', '15'};
osctvBase.numSubsetsValues = {'t'};%{ '[26 2]', '[51 3]', '[103 6]', '[205 13]', '[205 41]'};
osctvBase.cValues = {'t'};%{'0.001', '0.005', '0.01', '0.05', '0.1'};
