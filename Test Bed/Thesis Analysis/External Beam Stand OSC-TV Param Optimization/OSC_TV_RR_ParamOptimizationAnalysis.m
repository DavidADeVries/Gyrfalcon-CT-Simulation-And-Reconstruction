...
osctv_RR = osctvBase;
osctv_RR.readPath = 'E:\Local Gyrfalcon Data\Imaging Scan Runs\Optical CT Imaging Scan Run (Gel 4-2)\';
osctv_RR.usedFloodFields = false;  
