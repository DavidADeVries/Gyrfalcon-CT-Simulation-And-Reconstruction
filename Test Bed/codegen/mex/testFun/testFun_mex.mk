START_DIR = C:\Users\MPRadmin\GITREP~1\GYRFAL~1\TESTBE~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2017a
MAKEFILE = testFun_mex.mk

include testFun_mex.mki
...
MEX_FILE_NAME_WO_EXT = testFun_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\testFun"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\testFun/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
