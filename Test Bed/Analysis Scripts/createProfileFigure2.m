function [] = createProfileFigure2(savePath, x, profileData, profileLabels, lineColours, lineWidths, xLabel, yLabel, yLimits)
...
for i=1:numProfiles
    ...
    plot(x, profileData{i}, lineColours{i}, 'LineWidth', lineWidths{i});
%     if i==1
