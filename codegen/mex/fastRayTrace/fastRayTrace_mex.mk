START_DIR = C:\Users\MPRadmin\GITREP~1\GYRFAL~1

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2017a
MAKEFILE = fastRayTrace_mex.mk

include fastRayTrace_mex.mki
...
SRC_FILES =  \
	...
	sign.c \
	norm.c \
	_coder_fastRayTrace_info.c \
	_coder_fastRayTrace_api.c \
	_coder_fastRayTrace_mex.c \
	fastRayTrace_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = fastRayTrace_mex
