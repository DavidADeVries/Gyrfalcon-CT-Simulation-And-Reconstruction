classdef Detector < GyrfalconObject
    ...
    properties
        ...
        angularDetectorRadius
        angularDetectorRadiusUnits = Units.m
    ...
    methods
        ...
        function bool = isPlanar(detector)
            isPlanar1 = detector.singleDetectorDimensions(1).isPlanar();
            isPlanar2 = detector.singleDetectorDimensions(2).isPlanar();
            
            bool = isPlanar1 && isPlanar2;
        end

        function dimensions = getSingleDetectorDimensionsInM(detector)
            radiusInM = detector.getAngularDetectorRadiusInM();
            
            xy = detector.singleDetectorDimensions(1).getLengthInM(radiusInM);
            z = detector.singleDetectorDimensions(2).getLengthInM(radiusInM);

            dimensions = [xy,z];
        end
        
        function radius = getAngularDetectorRadiusInM(detector)
            radius = detector.angularDetectorRadiusUnits.convertToM(detector.angularDetectorRadius);
        end
                
        function detector = setDefaultValues(detector)
            detector.location = [0,-1];
            
            detector.angularDetectorRadius = 1;
        ...
        function bool = equal(detector1, detector2)
            ...
            b9 = detector1.angularDetectorRadius == detector2.angularDetectorRadius;
            b10 = detector1.angularDetectorRadiusUnits == detector2.angularDetectorRadiusUnits;
        ...
        function app = setGUI(detector, app)
            ...
            app.DetectorAngularDetectorRadiusEditField.Value = detector.angularDetectorRadius;
            
            if detector.isPlanar()
                 app.DetectorAngularDetectorRadiusEditField.Enable = 'off';
                 app.SetRadiusToIsocentreDistanceButton.Enable = 'off';
                 app.SetRadiusToSourceDistanceButton.Enable = 'off';
            else
                 app.DetectorAngularDetectorRadiusEditField.Enable = 'on';
                 app.SetRadiusToIsocentreDistanceButton.Enable = 'on';
                 app.SetRadiusToSourceDistanceButton.Enable = 'on';
            end
        ...
        function detector = createFromGUI(detector, app)
            ...
            detector.angularDetectorRadius = app.DetectorAngularDetectorRadiusEditField.Value;
