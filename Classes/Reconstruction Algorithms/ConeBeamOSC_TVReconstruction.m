classdef ConeBeamOSC_TVReconstruction < Reconstruction
    ...
    methods
        ...
        function recon = runReconstruction(recon, reconRun, simulationOrImagingScanRun, app, projectionData_I0, projectionData_I, rayRejectionMaps)
            ...
            catheterMapLoadPath = makePath(removeLastItemFromPath(reconRun.savePath), 'Catheter Maps.mat');
            catheterMapLoadPath = strrep(catheterMapLoadPath, ' FF-D', '');
            catheterMapLoadPath = strrep(catheterMapLoadPath, ' FF-R', '');
